...
CREATE TABLE `user_bank_list`.`user` (
`userId` INT NOT NULL,
  `name` VARCHAR(45) NULL,
  `surname` VARCHAR(45) NULL,
  PRIMARY KEY (`userId`));

CREATE TABLE `user_bank_list`.`account` (
  `accountId` INT NOT NULL,
  `account` INT NULL,
  `userId` INT NULL,
  PRIMARY KEY (`accountId`), FOREIGN KEY (userId) REFERENCES user (userId));

INSERT INTO `user_bank_list`.`user` (`userId`, `name`, `surName`) VALUES ('1', 'Bill', 'Gates');
INSERT INTO `user_bank_list`.`user` (`userId`, `name`, `surName`) VALUES ('2', 'Bill', 'Clinton');
INSERT INTO `user_bank_list`.`user` (`userId`, `name`, `surName`) VALUES ('3', 'Clint', 'Eastwood');
INSERT INTO `user_bank_list`.`user` (`userId`, `name`, `surName`) VALUES ('4', 'Jonny', 'Depp');
INSERT INTO `user_bank_list`.`user` (`userId`, `name`, `surName`) VALUES ('5', 'Tom', 'Cruise');
INSERT INTO `user_bank_list`.`user` (`userId`, `name`, `surName`) VALUES ('6', 'Tony', 'Stark');
INSERT INTO `user_bank_list`.`user` (`userId`, `name`, `surName`) VALUES ('7', 'Kate', 'Moss');
INSERT INTO `user_bank_list`.`user` (`userId`, `name`, `surName`) VALUES ('8', 'Mike', 'Tyson');
INSERT INTO `user_bank_list`.`user` (`userId`, `name`, `surName`) VALUES ('9', 'Li', 'Mao');
INSERT INTO `user_bank_list`.`user` (`userId`, `name`, `surName`) VALUES ('10', 'John', 'Golt');
